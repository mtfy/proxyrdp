	...
	<MainLayout :user="props.user">
		...
		<div class="bg-white flex flex-col justify-center relative max-w-[100%] w-full py-[48px] md:py-[72px] m-0">
			<div class="motify-container relative w-full max-w-[100%] p-0 m-0 pt-5">
				<div class="motify-padder flex flex-col w-full items-center justify-center m-0">
					<span class="inline-flex text-theme-primary-600 font-motify font-bold whitespace-pre-wrap text-[32px] leading-[36.8px] md:text-[48px] md:leading-[56px]">
						Key Features
					</span>
					<p class="inline-flex text-theme-primary-700 p-0 text-center m-0 mt-[20px] text-[18px] leading-[26px] md:text-[24px] leading-[32px]">
						Lorem ipsum dolor sit amet consectetur adipiscing elit justo, ligula nisl faucibus ac venenatis accumsan interdum, sociosqu erat varius id curae fames lobortis.
					</p>
				</div>
				<div class="flex flex-col w-full flex-wrap flex-grow px-[24px] py-[16px] md:py-[80px] md:px-[100px]">
					<div class="grid grid-cols-2 w-full gap-y-6 gap-x-4 p-0 m-0 md:grid-cols-4 md:gap-x-4 md:gap-y-0">
						<div class="flex flex-col justify-center items-center p-0 m-0 font-motify text-theme-primary-700">
							<div class="flex flex-col w-full p-0 m-0 justify-center items-center pb-[8px] md:pb-[35px]">
								<img role="img" class="inline-flex max-h-[48px] pointer-events-none select-none" src="data:image/svg+xml;base64," alt="Picture" />
							</div>
							<div class="flex flex-col w-full pb-[4px] md:pb-[16px] m-0 justify-center items-center">
								<span class="font-bold whitespace-pre-wrap text-center text-[12px] leading-[18px] md:text-[18px]">Customizable Hardware</span>
							</div>
							<div class="flex flex-col w-full p-0 m-0 items-center">
								<p class="text-center p-0 m-0 whitespace-pre-wrap text-center text-[12px] leading-[18px] md:text-[16px]">Non natoque suscipit quis sagittis hac morbi netus.</p>
							</div>
						</div>
						...
						<div class="flex flex-col justify-center items-center p-0 m-0 font-motify text-theme-primary-700">
							...
							<div class="flex flex-col w-full pb-[4px] md:pb-[16px] m-0 justify-center items-center">
								<span class="font-bold whitespace-pre-wrap text-center text-[12px] leading-[18px] md:text-[18px]">Premium Support</span>
							</div>
							<div class="flex flex-col w-full p-0 m-0 items-center">
								<p class="text-center p-0 m-0 whitespace-pre-wrap text-center text-[12px] leading-[18px] md:text-[16px]">Non natoque suscipit quis sagittis hac morbi netus.</p>
							</div>
						...
						<div class="flex flex-col justify-center items-center p-0 m-0 font-motify text-theme-primary-700">
							...
							<div class="flex flex-col w-full pb-[4px] md:pb-[16px] m-0 justify-center items-center">
								<span class="font-bold whitespace-pre-wrap text-center text-[12px] leading-[18px] md:text-[18px]">Uptime</span>
							</div>
							<div class="flex flex-col w-full p-0 m-0 items-center">
								<p class="text-center p-0 m-0 whitespace-pre-wrap text-center text-[12px] leading-[18px] md:text-[16px]">Non natoque suscipit quis sagittis hac morbi netus.</p>
							</div>
						...
						<div class="flex flex-col justify-center items-center p-0 m-0 font-motify text-theme-primary-700">
							...
							<div class="flex flex-col w-full pb-[4px] md:pb-[16px] m-0 justify-center items-center">
								<span class="font-bold whitespace-pre-wrap text-center text-[12px] leading-[18px] md:text-[18px]">Superior speed</span>
							</div>
							<div class="flex flex-col w-full p-0 m-0 items-center">
								<p class="text-center p-0 m-0 whitespace-pre-wrap text-center text-[12px] leading-[18px] md:text-[16px]">Non natoque suscipit quis sagittis hac morbi netus.</p>
							</div>
		...
		<div class="bg-theme-background-alt flex flex-col justify-center relative max-w-[100%] w-full m-0 px-[60px] py-[48px] md:py-[160px] md:px-[80px] 2xl:px-[100px] 3xl:px-[100px]">
			<div class="flex flex-col relative max-w-[1650px] w-full m-0 mx-auto p-0">
				<div class="flex flex-col w-full max-w-[100%] gap-y-[64px] md:gap-y-[128px] p-0 m-0">
					<div class="flex flex-col md:flex-row w-full">
						...
						<div class="flex flex-col w-full mt-8 md:mt-0 md:w-6/12">
							<div class="flex flex-col w-full justify-center flex-grow items-center">
								<span class="flex flex-col text-center whitespace-pre-wrap text-theme-primary-500 text-[32px] leading-[36.8px] font-bold md:text-[48px] md:leading-[55.8px]">Virtual Private Servers</span>
								<p class="flex flex-col text-center whitespace-pre-wrap text-theme-primary-400 text-[18px] leading-[26px] mt-[16px] md:text-[24px] md:leading-[32px] md:mt-[24px]">Ne per fugit debet, ne omnes tollit duo! Quas laudem soleat mei at, ad eos commodo quaerendum. In magna periculis duo, wisi labitur mea cu! Ut per deserunt petentium, at sea erant ubique. Qui id summo simul semper, id nec augue dignissim.</p>
							</div>
						</div>
					</div>
					<div class="flex flex-col md:flex-row w-full">
						<div class="flex flex-col w-full mt-8 md:mt-0 md:w-6/12">
							<div class="flex flex-col w-full justify-center flex-grow items-center">
								<span class="flex flex-col text-center whitespace-pre-wrap text-theme-primary-500 text-[32px] leading-[36.8px] font-bold md:text-[48px] md:leading-[55.8px]">High Quality Proxies</span>
								<p class="flex flex-col text-center whitespace-pre-wrap text-theme-primary-400 text-[18px] leading-[26px] mt-[16px] md:text-[24px] md:leading-[32px] md:mt-[24px]">Te soluta veritus sensibus sit, mea ea definiebas mediocritatem? Ea pri falli albucius voluptaria, duo veritus omittantur eu. Ex accusamus interpretaris qui, novum errem offendit eu duo, id zril labores salutatus pro.</p>
							</div>
						</div>
						<div class="flex flex-col w-full md:w-6/12">
							<div class="flex flex-col w-full select-none justify-center items-center">
		...
		<div class="bg-white flex flex-col justify-center relative max-w-[100%] w-full p-0 pb-[48px] md:pb-[72px] m-0">
			<div class="motify-container relative w-full max-w-[100%] p-0 m-0 pt-5">
				<div class="motify-padder flex flex-col w-full items-center justify-center m-0">
					<span class="inline-flex text-theme-primary-600 font-motify font-bold whitespace-pre-wrap text-[32px] leading-[36.8px] md:text-[48px] md:leading-[56px]">All Plans Include</span>
				</div>
				<div class="flex flex-col w-full relative px-[18px] md:px-0 m-0">
					<div class="flex flex-col md:flex-row gap-y-14 gap-x-0 md:gap-y-16 md:gap-x-5 2xl:gap-x-16 w-full justify-center items-center relative flex-wrap flex-grow">
						<div class="flex flex-col w-full md:w-6/12 md:max-w-[49%] 2xl:max-w-[45%] m-0 p-0">
							<div class="flex flex-row shrink-0 items-center w-full m-0 p-0 min-h-[36px] max-h-[36px] h-[36px] md:min-h-[52px] md:max-h-[52px] md:h-[52px] mb-3">
								<div class="flex flex-col items-center justify-center bg-gradient-to-r from-theme-primary-700 to-theme-primary-500 min-h-[36px] max-h-[36px] h-[36px] md:min-h-[52px] md:max-h-[52px] md:h-[52px] min-w-[36px] max-w-[36px] md:min-w-[52px] md:max-w-[52px] w-full rounded-[50%] m-0 p-0">
									<svg xmlns="http://www.w3.org/2000/svg" role="img" class="inline-flex text-white select-none pointer-events-none max-w-[24px] max-h-[24px] min-h-[24px] h-[24px] md:max-w-[30px] md:max-h-[30px] md:min-h-[30px] md:h-[30px] w-full" viewBox="0 0 24 24" fill="none" stroke="#FFFFFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"></circle><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"></path></svg>
								</div>
								<div class="flex flex-col min-h-[36px] max-h-[36px] h-[36px] md:min-h-[52px] md:max-h-[52px] md:h-[52px] w-full m-0 p-0 pl-[14px] md:pl-[24px]">
									<span class="flex flex-col capitalize truncate whitespace-pre-wrap text-zinc-800 font-medium font-monsterrat text-[24px] leading-[36px] md:leading-[52px] md:text-[32px] m-0 p-0">Control panel</span>
								</div>
							</div>
							<div class="flex flex-col w-full p-0 m-0">
								<p class="flex flex-col text-zinc-800 font-motify whitespace-pre-line text-[16px] leading-[24px] md:text-[18px] md:leading-[26px] m-0 p-0">Et soleat dolorem eligendi vim! Mea partem nominavi ut, unum iisque ad vel, eu pri errem nominati? At tantas accommodare eum, no sea vitae graecis temporibus! Qui scripta insolens perpetua id?</p>
							</div>
						</div>
						<div class="flex flex-col w-full md:w-6/12 md:max-w-[49%] 2xl:max-w-[45%] m-0 p-0">
							<div class="flex flex-row shrink-0 items-center w-full m-0 p-0 min-h-[36px] max-h-[36px] h-[36px] md:min-h-[52px] md:max-h-[52px] md:h-[52px] mb-3">
								<div class="flex flex-col items-center justify-center bg-gradient-to-r from-theme-primary-700 to-theme-primary-500 min-h-[36px] max-h-[36px] h-[36px] md:min-h-[52px] md:max-h-[52px] md:h-[52px] min-w-[36px] max-w-[36px] md:min-w-[52px] md:max-w-[52px] w-full rounded-[50%] m-0 p-0">
									<svg xmlns="http://www.w3.org/2000/svg" role="img" class="inline-flex text-white select-none pointer-events-none max-w-[24px] max-h-[24px] min-h-[24px] h-[24px] md:max-w-[30px] md:max-h-[30px] md:min-h-[30px] md:h-[30px] w-full" fill="#FFFFFF" viewBox="0 0 16 16"> <path fill-rule="evenodd" d="M7.646 5.146a.5.5 0 0 1 .708 0l2 2a.5.5 0 0 1-.708.708L8.5 6.707V10.5a.5.5 0 0 1-1 0V6.707L6.354 7.854a.5.5 0 1 1-.708-.708l2-2z" fill="white"></path> <path d="M4.406 3.342A5.53 5.53 0 0 1 8 2c2.69 0 4.923 2 5.166 4.579C14.758 6.804 16 8.137 16 9.773 16 11.569 14.502 13 12.687 13H3.781C1.708 13 0 11.366 0 9.318c0-1.763 1.266-3.223 2.942-3.593.143-.863.698-1.723 1.464-2.383zm.653.757c-.757.653-1.153 1.44-1.153 2.056v.448l-.445.049C2.064 6.805 1 7.952 1 9.318 1 10.785 2.23 12 3.781 12h8.906C13.98 12 15 10.988 15 9.773c0-1.216-1.02-2.228-2.313-2.228h-.5v-.5C12.188 4.825 10.328 3 8 3a4.53 4.53 0 0 0-2.941 1.1z" fill="#FFFFFF"></path></svg>
								</div>
								<div class="flex flex-col min-h-[36px] max-h-[36px] h-[36px] md:min-h-[52px] md:max-h-[52px] md:h-[52px] w-full m-0 p-0 pl-[14px] md:pl-[24px]">
									<span class="flex flex-col capitalize truncate whitespace-pre-wrap text-zinc-800 font-medium font-monsterrat text-[24px] leading-[36px] md:leading-[52px] md:text-[32px] m-0 p-0">High uptime</span>
								</div>
							</div>
							<div class="flex flex-col w-full p-0 m-0">
								<p class="flex flex-col text-zinc-800 font-motify whitespace-pre-line text-[16px] leading-[24px] md:text-[18px] md:leading-[26px] m-0 p-0">Essent veritus molestie cum ea! No vix adipisci corrumpit instructior, sint dicam eu mea. Sumo quaeque suavitate ea mea? Sed vidisse laoreet qualisque et, atqui clita repudiandae ad vis, vim justo eligendi deserunt te.</p>
							</div>
						</div>
						<div class="flex flex-col w-full md:w-6/12 md:max-w-[49%] 2xl:max-w-[45%] m-0 p-0">
							<div class="flex flex-row shrink-0 items-center w-full m-0 p-0 min-h-[36px] max-h-[36px] h-[36px] md:min-h-[52px] md:max-h-[52px] md:h-[52px] mb-3">
								<div class="flex flex-col items-center justify-center bg-gradient-to-r from-theme-primary-700 to-theme-primary-500 min-h-[36px] max-h-[36px] h-[36px] md:min-h-[52px] md:max-h-[52px] md:h-[52px] min-w-[36px] max-w-[36px] md:min-w-[52px] md:max-w-[52px] w-full rounded-[50%] m-0 p-0">
									<svg xmlns="http://www.w3.org/2000/svg" role="img" class="inline-flex select-none pointer-events-none max-w-[24px] max-h-[24px] min-h-[24px] h-[24px] md:max-w-[30px] md:max-h-[30px] md:min-h-[30px] md:h-[30px] w-full" fill="#FFFFFF" viewBox="0 0 16 16"> <path d="M5.52.359A.5.5 0 0 1 6 0h4a.5.5 0 0 1 .474.658L8.694 6H12.5a.5.5 0 0 1 .395.807l-7 9a.5.5 0 0 1-.873-.454L6.823 9.5H3.5a.5.5 0 0 1-.48-.641l2.5-8.5zM6.374 1 4.168 8.5H7.5a.5.5 0 0 1 .478.647L6.78 13.04 11.478 7H8a.5.5 0 0 1-.474-.658L9.306 1H6.374z"/></svg>
								</div>
								<div class="flex flex-col min-h-[36px] max-h-[36px] h-[36px] md:min-h-[52px] md:max-h-[52px] md:h-[52px] w-full m-0 p-0 pl-[14px] md:pl-[24px]">
									<span class="flex flex-col capitalize truncate whitespace-pre-wrap text-zinc-800 font-medium font-monsterrat text-[24px] leading-[36px] md:leading-[52px] md:text-[32px] m-0 p-0">Instant deployment</span>
								</div>
							</div>
							<div class="flex flex-col w-full p-0 m-0">
								<p class="flex flex-col text-zinc-800 font-motify whitespace-pre-line text-[16px] leading-[24px] md:text-[18px] md:leading-[26px] m-0 p-0">Eleifend laboramus similique ad pri. Mel ne deserunt gloriatur democritum, ad assum doctus disputationi vel! Eu usu quaeque nusquam nominati. Duo lorem timeam bonorum ut, vis ad tota utroque nusquam! Modo tantas mea no, sanctus recteque ne duo.</p>
							</div>
						</div>
						<div class="flex flex-col w-full md:w-6/12 md:max-w-[49%] 2xl:max-w-[45%] m-0 p-0">
							<div class="flex flex-row shrink-0 items-center w-full m-0 p-0 min-h-[36px] max-h-[36px] h-[36px] md:min-h-[52px] md:max-h-[52px] md:h-[52px] mb-3">
								<div class="flex flex-col items-center justify-center bg-gradient-to-r from-theme-primary-700 to-theme-primary-500 min-h-[36px] max-h-[36px] h-[36px] md:min-h-[52px] md:max-h-[52px] md:h-[52px] min-w-[36px] max-w-[36px] md:min-w-[52px] md:max-w-[52px] w-full rounded-[50%] m-0 p-0">
									<svg xmlns="http://www.w3.org/2000/svg" role="img" class="inline-flex select-none pointer-events-none max-w-[24px] max-h-[24px] min-h-[24px] h-[24px] md:max-w-[30px] md:max-h-[30px] md:min-h-[30px] md:h-[30px] w-full" fill="#FFFFFF" viewBox="0 0 16 16"><path d="M8 1a5 5 0 0 0-5 5v1h1a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V6a6 6 0 1 1 12 0v6a2.5 2.5 0 0 1-2.5 2.5H9.366a1 1 0 0 1-.866.5h-1a1 1 0 1 1 0-2h1a1 1 0 0 1 .866.5H11.5A1.5 1.5 0 0 0 13 12h-1a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1h1V6a5 5 0 0 0-5-5z" fill="#FFFFFF"></path></svg>
								</div>
								<div class="flex flex-col min-h-[36px] max-h-[36px] h-[36px] md:min-h-[52px] md:max-h-[52px] md:h-[52px] w-full m-0 p-0 pl-[14px] md:pl-[24px]">
									<span class="flex flex-col capitalize truncate whitespace-pre-wrap text-zinc-800 font-medium font-monsterrat text-[24px] leading-[36px] md:leading-[52px] md:text-[32px] m-0 p-0">Fast support</span>
								</div>
							</div>
							<div class="flex flex-col w-full p-0 m-0">
								<p class="flex flex-col text-zinc-800 font-motify whitespace-pre-line text-[16px] leading-[24px] md:text-[18px] md:leading-[26px] m-0 p-0">Vis alia mediocrem persequeris ei, congue dissentiet an mea. Eros omnesque indoctum et est, dico definitionem ex pro! Quo ei posse ipsum euripidis, te eros falli forensibus per. Ex soluta adipiscing est, ut qui debitis pertinacia. Facilisis scripserit ei quo.</p>
							</div>
						</div>
					</div>
				</div>
